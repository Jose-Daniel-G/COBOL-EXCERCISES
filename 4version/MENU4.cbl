       ...
       *> --- MENU VERTICAL DESPLEGABLE ---
       ...
       01  FINANCIERO.
           ...
           05 LINE 07 COL 10 VALUE "| P. Program               |" BACKGROUND-COLOR 7 FOREGROUND-COLOR 1.
           05 LINE 08 COL 10 VALUE "| C. Clientes              |" BACKGROUND-COLOR 7 FOREGROUND-COLOR 1.
           05 LINE 09 COL 10 VALUE "| L. LISTADO               |" BACKGROUND-COLOR 7 FOREGROUND-COLOR 1.
           05 LINE 10 COL 10 VALUE "| S. Salir al Menu Sup.    |" BACKGROUND-COLOR 7 FOREGROUND-COLOR 1.
           05 LINE 11 COL 10 VALUE "+--------------------------+" BACKGROUND-COLOR 7 FOREGROUND-COLOR 0.

       01  MENU-SUBMENU.
            05  GRUPO-VERDE BACKGROUND-COLOR 6 FOREGROUND-COLOR 7.*> Grupo con color Turquesa/Verde (Fondo 6 o 3 dependiendo del terminal)
            10 LINE 05 COL 33 VALUE "+-----------------------------+".
            10 LINE 06 COL 33 VALUE "| A.B.M CLIENTES              |".
            10 LINE 07 COL 33 VALUE "+-----------------------------+".
            10 LINE 08 COL 33 VALUE "| Listar                      |". 
            10 LINE 09 COL 33 VALUE "| Regresar                    |". 
            10 LINE 10 COL 33 VALUE "+-----------------------------+".  
